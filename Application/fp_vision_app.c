...
/** @addtogroup Person_Presence_Detection_Google_Model
 * @{
 */
...
/**
* @brief  Get the subsequent frame available and: 1)send it to LCD for display, 2) make it available for subsequent processing
