...
#define AI_NETWORK_MODEL_SIGNATURE     "4e409e907a44608d5ffdb1feb5c7c89d"
...
#define AI_TOOLS_DATE_TIME   "Thu Aug 13 19:33:54 2020"
...
AI_STATIC ai_array input_output_array;   /* Array #85 */
...
AI_STATIC ai_tensor input_output;   /* Tensor #85 */
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 68, 1, 1), AI_STRIDE_INIT(4, 1, 1, 68, 68),
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    conv2d_1_scratch0_array.data = AI_PTR(activations + 19396);
    conv2d_1_scratch0_array.data_start = AI_PTR(activations + 19396);
    conv2d_0_scratch0_array.data = AI_PTR(activations + 19396);
    conv2d_0_scratch0_array.data_start = AI_PTR(activations + 19396);
    input_output_array.data = AI_PTR(NULL);
    input_output_array.data_start = AI_PTR(NULL);
    conv2d_0_output_array.data = AI_PTR(activations + 964);
    conv2d_0_output_array.data_start = AI_PTR(activations + 964);
